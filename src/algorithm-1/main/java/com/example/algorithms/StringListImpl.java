...
import com.example.algorithms.Exception.InvalidIndexException;
import com.example.algorithms.Exception.NullItemException;
import com.example.algorithms.Exception.StorageIsFullException;
...
public class StringListImpl implements StringList {
    ...
    private void validateItem(String item) {
        if (item == null) {
            throw new NullItemException("Неверный итем");
        }
    }
